...
export default function PreLogin({ navigation }: { navigation?: any }) {
  ...
  // Slide Content Data based on Problem Statement
  const slides = [
    {
      category: "DATA MANAGEMENT",
      title: "Centralized Student Records",
      description: "Eliminate scattered data. Manage academic records, activities, and achievements in one secure system.",
    },
    {
      category: "ACADEMIC TRACKING",
      title: "Your Complete Profile",
      description: "Access your grades, participation history, and achievements instantly without manual searching.",
    },
    {
      category: "MENTORSHIP",
      title: "Connect & Collaborate",
      description: "Bridge the gap between juniors and seniors for better guidance, mentorship, and academic support.",
    },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Content Card - Perfectly Centered */}
